...
export default function MTH113_114({count,setCount,reviews,Name,Prof,YearnSem,Difficulty,Grading,Satisfaction,Teaching,
  Workload,setDifficulty,setName,setProf,setYearnSem,setGrading,setWorkload,setSatisfaction,setTeaching,modList,setModList}) {
    // the arguments in the function MTH113_114 are the various props that we are accepting.
  ...
  return (
  //here some of the code is provided by the MUI template, except where I have inserted the comments
      ...
      <main>
        ...
        >
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="text.secondary" paragraph>
              Atleast it's better than MTH111/112
            </Typography>
            <Stack
              sx={{ pt: 4 }}
              direction="row"
        ...
        <Container sx={{ py: 8 }}>
          <Grid container spacing={4}>
            {/* {creating a map for all the elements in the MTH113/114 reviews list, 
